...
export class LoginComponent implements OnInit {
  ...
  login(){
    ...
    this.http.post<{[login: string]: any}>('http://localhost:3001/users/login', {username: username, password: password, responseType: 'application/json'}, {headers: headers}).subscribe((res) => {
    console.log(res);  
